...
export const createReviewValidator = [
  ...
  check("product")
    ...
    .custom(async (val, { req }) => {
      ...
      if (existingReview) {
        // Update the existing review instead of blocking
        await Review.findByIdAndUpdate(existingReview._id, { review: req.body.review });
        return Promise.reject(new createError("Your review has been updated."));
      }
    }),
